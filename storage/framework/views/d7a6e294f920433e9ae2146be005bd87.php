    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6 animate-fade-in delay-100">
                <form action="<?php echo e(route('pelanggaran.laporan.siswa')); ?>" method="GET" class="space-y-4">
                    ...
                    <div class="flex flex-wrap gap-3 pt-2">
                        ...
                        <a href="<?php echo e(route('pelanggaran.laporan.siswa')); ?>" class="px-6 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors">
                            Reset
                        </a>
                    </div>
                </form>
                ...
                <div class="bg-white rounded-xl p-5 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e($totalSiswaMelanggar); ?></p>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[700px]">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $rekapSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 font-medium"><?php echo e($siswa->nama_siswa); ?></td>
            ...
            <!-- Detail Pelanggaran -->
            <?php if(count($pelanggaranData) > 0): ?>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $pelanggaranData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600 max-w-xs truncate" title="<?php echo e($data->deskripsi); ?>"><?php echo e($data->deskripsi ?: '-'); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($data->nama_petugas); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-500 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($data->created_at)->format('d/m/Y H:i')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/data-siswa-melanggar.blade.php ENDPATH**/ ?>