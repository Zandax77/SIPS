                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-3 pl-4 border-l border-gray-200">
                            <div class="text-right hidden sm:block">
                                <p class="text-sm font-semibold text-gray-800"><?php echo e(session('nama_petugas')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(session('jabatan')); ?></p>
                            </div>
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-100 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:h-screen lg:overflow-y-auto lg:block flex-shrink-0">
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.petugas.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-100">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                <div class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center">
                                                    <span class="text-xs font-medium text-indigo-600"><?php echo e(substr($p->name, 0, 1)); ?></span>
                                                </div>
                                                <span class="text-sm font-medium text-gray-800"><?php echo e($p->name); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($p->email); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                            <?php if($p->jabatan === 'Wali Kelas' && $p->kelas): ?>
                                                <?php echo e($p->jabatan); ?> - <?php echo e($p->kelas); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <?php if($p->role !== 'admin' && $p->id != session('id_petugas')): ?>
                                                    <form action="<?php echo e(route('admin.petugas.reset-password', $p->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Reset Password ke 123456" onclick="return confirm('Apakah Anda yakin ingin mereset password ' . $p->name . ' menjadi \"123456\"?')">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <?php if($p->status !== 'active' && $p->role !== 'admin'): ?>
                                                    <form action="<?php echo e(route('admin.petugas.activate', $p->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php if($p->status === 'active' && $p->role !== 'admin' && $p->id != session('id_petugas')): ?>
                                                    <form action="<?php echo e(route('admin.petugas.block', $p->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php if($p->role !== 'admin' && $p->id != session('id_petugas')): ?>
                                                    <form action="<?php echo e(route('admin.petugas.delete', $p->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/kelola-petugas.blade.php ENDPATH**/ ?>