...
<head>
    ...
    <title>Laporan Rekap Kelas - <?php echo e($namaSekolah); ?></title>
...
<body class="bg-white" onload="window.print()">
    <div class="max-w-7xl mx-auto px-4 py-6">
            ...
            <table class="w-full">
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <h1 class="text-xl font-bold text-gray-800 uppercase tracking-wide"><?php echo e($namaSekolah); ?></h1>
                        ...
                        <p class="text-gray-500 text-sm">Tanggal Cetak: <?php echo e($tanggal); ?></p>
                    </td>
                    <td class="w-16"></td>
                </tr>
            </table>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $rekap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelasData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="mb-6">
            <h3 class="text-sm font-bold text-gray-800 mb-2" style="border-left: 4px solid #4f46e5; padding-left: 8px;">
                KELAS <?php echo e($kelasData->kelas); ?>

                <span class="text-gray-500 font-normal">(<?php echo e($kelasData->total_siswa); ?> siswa, <?php echo e($kelasData->total_pelanggaran); ?> pelanggaran)</span>
            </h3>

            <?php
            // Get detailed violations for this class
            $detailPelanggaran = DB::table('pelanggarans')
                ->select(
            ...
            <?php if(count($detailPelanggaran) > 0): ?>
            <table class="custom-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $detailPelanggaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($index + 1); ?></td>
                        <td class="text-center"><?php echo e($detail->nis); ?></td>
                        <td class="font-medium"><?php echo e($detail->nama_siswa); ?></td>
                        <td><?php echo e($detail->jenis_pelanggaran); ?></td>
                        <td class="text-center">
                            <span class="px-1 py-0.5 rounded text-xs font-semibold
                                <?php if($detail->kategori == 'Ringan'): ?> text-green-800
                                <?php elseif($detail->kategori == 'Sedang'): ?> text-yellow-800
                                <?php else: ?> text-red-800 <?php endif; ?>"
                                style="<?php if($detail->kategori == 'Ringan'): ?> background-color: #dcfce7;
                                <?php elseif($detail->kategori == 'Sedang'): ?> background-color: #fef3c7;
                        ...
                        <td class="text-center font-semibold
                            <?php if($detail->kategori == 'Ringan'): ?> text-green-700
                            <?php elseif($detail->kategori == 'Sedang'): ?> text-yellow-700
                            <?php else: ?> text-red-700 <?php endif; ?>">
                            <?php echo e($detail->poin); ?>

                        </td>
                        <td class="text-center"><?php echo e(\Carbon\Carbon::parse($detail->created_at)->format('d/m/Y')); ?></td>
                        <td class="text-gray-600"><?php echo e($detail->deskripsi ?: '-'); ?></td>
                    </tr>
                ...
                <tfoot>
                    <tr style="background-color: #e5e7eb; font-weight: bold;">
                        ...
                        <td class="text-center"><?php echo e($kelasData->total_poin); ?></td>
                        <td colspan="2"></td>
                    </tr>
                </tfoot>
            </table>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/pdf/laporan-rekap-kelas.blade.php ENDPATH**/ ?>