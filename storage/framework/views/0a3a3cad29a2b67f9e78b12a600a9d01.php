    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6 animate-fade-in delay-100">
                <form action="<?php echo e(route('siswa.poin')); ?>" method="GET" class="flex flex-col sm:flex-row gap-4">
                    <!-- Search Input -->
                    <div class="flex-1">
                    ...
                    <div class="w-full sm:w-48">
                        ...
                        <select name="sort" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all outline-none bg-white">
                            <option value="poin_desc" <?php echo e($sortBy == 'poin_desc' ? 'selected' : ''); ?>>Poin Tertinggi</option>
                            <option value="poin_asc" <?php echo e($sortBy == 'poin_asc' ? 'selected' : ''); ?>>Poin Terendah</option>
                            <option value="nama_asc" <?php echo e($sortBy == 'nama_asc' ? 'selected' : ''); ?>>Nama A-Z</option>
                            <option value="nama_desc" <?php echo e($sortBy == 'nama_desc' ? 'selected' : ''); ?>>Nama Z-A</option>
                            <option value="kelas" <?php echo e($sortBy == 'kelas' ? 'selected' : ''); ?>>Per Kelas</option>
                        </select>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e($siswa->total()); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-emerald-600 mt-1">
                                <?php echo e($siswa->where('total_poin', 0)->count()); ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-amber-600 mt-1">
                                <?php echo e($siswa->filter(function($s) { return $s->total_poin > 0 && $s->total_poin <= 10; })->count()); ?>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-rose-600 mt-1">
                                <?php echo e($siswa->filter(function($s) { return $s->total_poin > 10; })->count()); ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden animate-fade-in delay-300">
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-white">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('siswa.poin')); ?>" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
                            Lihat Semua
                        </a>
                    </div>
                </div>
                ...
                <?php if(count($siswa) > 0): ?>
                                ...
                                <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e(($siswa->currentPage() - 1) * $siswa->perPage() + $index + 1); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php if($data->total_poin == 0): ?>
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-700">
                                                    <?php echo e($data->total_poin); ?> Poin
                                                </span>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                            <?php echo e($data->total_pelanggaran); ?>x
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="<?php echo e(route('siswa.detail', $data->id)); ?>"
                    ...
                    <div class="px-6 py-4 border-t border-gray-100">
                        <?php echo e($siswa->appends(['search' => $search, 'sort' => $sortBy])->links()); ?>
