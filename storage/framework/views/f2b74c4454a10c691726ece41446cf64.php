        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-100 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:h-screen lg:overflow-y-auto lg:block flex-shrink-0">
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-100">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden animate-fade-in">
                    ...
                    <div class="mx-6 mt-4 px-4 py-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-emerald-700"><?php echo e(session('success')); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_sekolah" id="nama_sekolah" value="<?php echo e(old('nama_sekolah', $namaSekolah)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="alamat_sekolah" id="alamat_sekolah" rows="3"
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                                placeholder="Contoh: Jl. Pendidikan No. 123, Jakarta"><?php echo e(old('alamat_sekolah', $alamatSekolah)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="telepon_sekolah" id="telepon_sekolah" value="<?php echo e(old('telepon_sekolah', $teleponSekolah)); ?>"
                                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                                placeholder="Contoh: 021-1234567">
                            <?php $__errorArgs = ['telepon_sekolah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/pengaturan.blade.php ENDPATH**/ ?>