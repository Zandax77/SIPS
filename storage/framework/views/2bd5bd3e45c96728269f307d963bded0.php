...
<head>
    ...
    <title>Dashboard - <?php echo e($namaSekolah); ?> SIPS</title>
    ...
    <div class="relative min-h-screen flex flex-col lg:flex-row">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <span class="text-xl font-bold text-gray-800"><?php echo e($namaSekolah); ?></span>
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-100 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:h-screen lg:overflow-y-auto lg:block flex-shrink-0">
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <!-- Change Password -->
                    <a href="<?php echo e(route('password.change')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if(strtolower($role ?? 'petugas') !== 'osis'): ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition class="ml-4 mt-1 space-y-1 bg-gray-50 rounded-lg overflow-hidden" style="display: none;">
                            <a href="<?php echo e(route('laporan.per-siswa')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                                Laporan per Siswa
                            </a>
                            <a href="<?php echo e(route('laporan.rekap-kelas')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                </svg>
                                Rekap per Kelas
                            </a>
                            <a href="<?php echo e(route('laporan.rekap-periode')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                </svg>
                                Rekap per Periode
                            </a>
                            <a href="<?php echo e(route('laporan.siswa-tertinggi')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 lg:ml-0">
            ...
            <main class="flex-1 max-w-7xl w-full mx-auto px-4 py-8">
                ...
                <?php if(($role ?? '') === 'admin' && isset($passwordResetRequests) && count($passwordResetRequests) > 0): ?>
                <div class="mb-8 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200 overflow-hidden animate-fade-in">
                    <div class="px-6 py-4 bg-amber-100 border-b border-amber-200 flex items-center justify-between">
                        ...
                        <span class="bg-amber-500 text-white text-xs font-bold px-2 py-1 rounded-full"><?php echo e(count($passwordResetRequests)); ?></span>
                    </div>
                    <div class="p-4 space-y-3">
                        <?php $__currentLoopData = $passwordResetRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $petugas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between bg-white rounded-xl p-4 shadow-sm">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-800"><?php echo e($petugas->name); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($petugas->email); ?> - <?php echo e($petugas->jabatan); ?></p>
                                        <p class="text-xs text-gray-400 mt-1">
                                            <?php echo e($petugas->password_reset_expires ? \Carbon\Carbon::parse($petugas->password_reset_expires)->format('d/m/Y H:i') : ''); ?>

                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <a href="<?php echo e(route('admin.petugas.index')); ?>" class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition-colors">
                                        Reset Password
                                    </a>
                                </div>
                            </div>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/dashboard.blade.php ENDPATH**/ ?>