...
<head>
    ...
    <title><?php echo e($namaSekolah); ?> - SIPS</title>
    ...
    <header class="relative z-10 bg-white/80 backdrop-blur-sm border-b border-gray-100 sticky top-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <!-- Login Button -->
                <a href="<?php echo e(route('login')); ?>" class="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 animate-fade-in delay-100">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($totalPelanggaran); ?></p>
                    </div>
                </div>
            </div>
            <?php else: ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 animate-fade-in delay-200">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($totalSiswaMelanggar); ?></p>
                    </div>
                </div>
            </div>
            <?php else: ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 animate-fade-in delay-300">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($totalKelasTerlibat); ?></p>
                    </div>
                </div>
            </div>
            <?php else: ?>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-12 animate-fade-in delay-400">
            ...
            <div class="h-64 md:h-80 flex items-center justify-center bg-gray-50 rounded-xl">
                <div class="text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="inline-block mt-4 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">Login Sekarang</a>
                </div>
            </div>
            <?php endif; ?>
        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $kelasStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($index + 1); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800"><?php echo e($kelas->kelas); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-700">
                                            <?php echo e($kelas->jumlah_siswa_pelaku); ?> siswa
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($kelas->jumlah_pelanggaran); ?> pelanggaran</td>
                                </tr>
                        ...
                        <tfoot class="bg-gray-50">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-indigo-600"><?php echo e($kelasStats->sum('jumlah_siswa_pelaku')); ?> siswa</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-indigo-600"><?php echo e($kelasStats->sum('jumlah_pelanggaran')); ?> pelanggaran</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
    ...
    <footer class="relative z-10 bg-white/60 backdrop-blur-sm border-t border-gray-100 py-6 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm text-gray-500">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($namaSekolah); ?> - SIPS
            </p>
        </div>
    </footer>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/welcome.blade.php ENDPATH**/ ?>