...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
            <!-- Back to Login -->
            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-indigo-600 transition-colors duration-200 mb-6">
            ...
            <form action="<?php echo e(route('password.email')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/forgot-password.blade.php ENDPATH**/ ?>