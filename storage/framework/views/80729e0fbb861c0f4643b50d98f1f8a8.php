...
<head>
    ...
    <title>Laporan Pelanggaran Kelas <?php echo e($selectedKelas); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="school-header">
            ...
            <div class="logo">
                <img src="<?php echo e($sekolah->logo_base64); ?>" alt="Logo">
            </div>
            <?php endif; ?>
            <div class="school-info">
                <h1><?php echo e($sekolah->nama_sekolah); ?></h1>
                <?php if($sekolah->alamat_sekolah): ?>
                <p><?php echo e($sekolah->alamat_sekolah); ?></p>
                <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><strong><?php echo e($selectedKelas); ?></strong></span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><?php echo e(\Carbon\Carbon::now()->format('d/m/Y H:i:s')); ?></span>
            </div>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="value"><?php echo e($totalPelanggaran); ?></div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <div class="value"><?php echo e(count($rekapPerSiswa)); ?></div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php if($siswa->total_poin >= 50): ?>
                            <span class="poin-badge poin-high"><?php echo e($siswa->total_poin); ?></span>
                        <?php elseif($siswa->total_poin >= 25): ?>
                            <span class="poin-badge poin-medium"><?php echo e($siswa->total_poin); ?></span>
                        <?php else: ?>
                            <span class="poin-badge poin-low"><?php echo e($siswa->total_poin); ?></span>
                        <?php endif; ?>
                    </td>
                </tr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo e($index + 1); ?></td>
                    <td>
                        <div style="font-weight: bold;"><?php echo e($data->nama_siswa); ?></div>
                        <div style="font-size: 9px; color: #666;"><?php echo e($data->nis); ?></div>
                    </td>
        ...
        <?php else: ?>
        <div class="no-data">
            <p>Tidak ada pelanggaran tercatat untuk kelas <?php echo e($selectedKelas); ?> pada periode ini.</p>
        </div>
        <?php endif; ?>
...
<?php /**PATH /Users/abscom23/Desktop/SIPS/resources/views/pdf/pelanggaran-kelas.blade.php ENDPATH**/ ?>