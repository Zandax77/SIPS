        ...
        <div class="flex-1 lg:ml-0">
            ...
            <main class="flex-1 max-w-2xl w-full mx-auto px-4 py-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 p-8 animate-fade-in">
                    ...
                    <form action="<?php echo e(route('password.update')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-indigo-600 transition-colors duration-200">
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/change-password.blade.php ENDPATH**/ ?>