...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
            ...
            <form action="<?php echo e(route('petugas.register')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <option value="Kesiswaan" <?php echo e(old('jabatan') == 'Kesiswaan' ? 'selected' : ''); ?>>Kesiswaan</option>
                            <option value="Wali Kelas" <?php echo e(old('jabatan') == 'Wali Kelas' ? 'selected' : ''); ?>>Wali Kelas</option>
                            <option value="Guru BK" <?php echo e(old('jabatan') == 'Guru BK' ? 'selected' : ''); ?>>Guru BK</option>
                            <option value="OSIS" <?php echo e(old('jabatan') == 'OSIS' ? 'selected' : ''); ?>>OSIS</option>
                        </select>
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kelas); ?>" <?php echo e(old('kelas') == $kelas ? 'selected' : ''); ?>><?php echo e($kelas); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-6">
                <p class="text-gray-500 text-sm">
                    Sudah punya akun?
                    <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 hover:text-indigo-700 font-medium transition-colors duration-200">
                        Masuk di sini
                    </a>
                </p>
            </div>
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/register.blade.php ENDPATH**/ ?>