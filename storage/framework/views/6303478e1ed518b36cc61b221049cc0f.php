...
<head>
    ...
    <title>Detail Siswa - <?php echo e($siswa->name); ?> - SIPS</title>
...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="relative min-h-screen flex flex-col">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('siswa.poin')); ?>" class="flex items-center gap-2 text-gray-600 hover:text-indigo-600 transition-colors">
        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="mb-6 bg-rose-50 border border-rose-200 rounded-xl p-4 animate-fade-in">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-rose-600"><?php echo e(session('error')); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if(isset($aiSuggestions) && $totalPoin > 0): ?>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mb-4 p-3 rounded-lg bg-white/60 border border-gray-100">
                            <div class="flex items-center gap-2">
                                <?php if($aiSuggestions['level']['color'] === 'rose'): ?>
                                <svg class="w-5 h-5 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                </svg>
                                <span class="font-medium text-rose-700"><?php echo e($aiSuggestions['level']['name']); ?></span>
                                <?php elseif($aiSuggestions['level']['color'] === 'orange'): ?>
                                <svg class="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                </svg>
                                <span class="font-medium text-orange-700"><?php echo e($aiSuggestions['level']['name']); ?></span>
                                <?php elseif($aiSuggestions['level']['color'] === 'amber'): ?>
                                <svg class="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                </svg>
                                <span class="font-medium text-amber-700"><?php echo e($aiSuggestions['level']['name']); ?></span>
                                <?php else: ?>
                                <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="font-medium text-blue-700"><?php echo e($aiSuggestions['level']['name']); ?></span>
                                <?php endif; ?>
                                <span class="text-gray-500 text-sm">- <?php echo e($aiSuggestions['level']['description']); ?></span>
                            </div>
                        </div>

                        <!-- Suggestions List -->
                        <div class="space-y-3">
                            <?php $__currentLoopData = $aiSuggestions['suggestions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suggestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 rounded-xl border transition-all duration-200 hover:shadow-md
                                <?php if($suggestion['type'] === 'critical' || $suggestion['type'] === 'serious'): ?>
                                    bg-rose-50 border-rose-200
                                <?php elseif($suggestion['type'] === 'high'): ?>
                                    bg-orange-50 border-orange-200
                                <?php elseif($suggestion['type'] === 'medium'): ?>
                                    bg-amber-50 border-amber-200
                                <?php elseif($suggestion['type'] === 'light'): ?>
                                    bg-blue-50 border-blue-200
                                <?php elseif($suggestion['type'] === 'positive'): ?>
                            ...
                            ">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-gray-800"><?php echo e($suggestion['title']); ?></h4>
                                        <p class="text-sm text-gray-600 mt-1"><?php echo e($suggestion['description']); ?></p>
                                        <div class="mt-2 p-2 rounded-lg bg-white/70">
                                            <p class="text-sm font-medium text-indigo-700">
                                                <span class="text-indigo-500">→</span> <?php echo e($suggestion['action']); ?>
            ...
            <?php if($hasEvidencePhotos && count($violationsWithPhotos) > 0): ?>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500"><?php echo e(count($violationsWithPhotos)); ?> pelanggaran dengan bukti</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6 animate-fade-in">
                ...
                <?php if(isset($tindakanSiswa) && count($tindakanSiswa) > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $tindakanSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tindakan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 rounded-xl border 
                            <?php if($tindakan->hasil_tindakan === 'Berhasil'): ?>
                                bg-emerald-50 border-emerald-200
                            <?php elseif($tindakan->hasil_tindakan === 'Tidak Berhasil'): ?>
                                bg-rose-50 border-rose-200
                            <?php elseif($tindakan->hasil_tindakan === 'Sedang Berlangsung'): ?>
                                bg-amber-50 border-amber-200
                            <?php else: ?>
                                bg-gray-50 border-gray-200
                            <?php endif; ?>
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 mb-2">
                                        <span class="font-semibold text-gray-800"><?php echo e($tindakan->jenis_tindakan); ?></span>
                                        <span class="px-2 py-0.5 rounded-full text-xs font-medium
                                            ...
                                            <?php endif; ?>
                                        ">
                                            <?php echo e($tindakan->hasil_tindakan); ?>

                                        </span>
                                    </div>
                                    <?php if($tindakan->deskripsi_tindakan): ?>
                                    <p class="text-sm text-gray-600 mb-2"><?php echo e($tindakan->deskripsi_tindakan); ?></p>
                                    <?php endif; ?>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="<?php echo e(route('siswa.tindakan.delete', ['id' => $siswa->id, 'tindakanId' => $tindakan->id])); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus tindakan ini?')">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden animate-fade-in delay-300">
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-white">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('siswa.pelanggaran.cetak', $siswa->id)); ?>" target="_blank" class="px-3 py-2 bg-rose-600 text-white rounded-lg hover:bg-rose-700 transition-colors font-medium flex items-center gap-2 text-sm">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                                        </svg>
                                        Cetak
                                ...
                                <?php $__currentLoopData = $pelanggaranDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <button onclick="showEvidence('<?php echo e($data->id); ?>')" class="p-2 text-rose-600 hover:text-rose-700 hover:bg-rose-50 rounded-lg transition-colors" title="Lihat Bukti">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                                </svg>
                                            </button>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e(\Carbon\Carbon::parse($data->created_at)->format('d/m/Y H:i')); ?>
        ...
        <div class="absolute inset-4 md:inset-10 bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $violationsWithPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $violation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-50 rounded-xl overflow-hidden border border-gray-200">
                        <!-- Photo/Document -->
                        <div class="aspect-video bg-gray-200 relative">
                            <?php if($violation->bukti_foto): ?>
                                <?php
                                ...
                                <?php if($isImage): ?>
                                    <img src="<?php echo e(asset('storage/' . $violation->bukti_foto)); ?>" 
                                ...
                                <?php else: ?>
                                    <div class="w-full h-full flex flex-col items-center justify-center bg-red-50">
                                        ...
                                        <span class="mt-2 text-sm text-red-600 font-medium uppercase"><?php echo e($extension); ?></span>
                                    </div>
                                <?php endif; ?>
                                
                                <!-- Category Badge -->
                                <span class="absolute top-2 right-2 px-2 py-1 rounded-lg text-xs font-bold
                                    <?php echo e($violation->kategori == 'Berat' ? 'bg-rose-500 text-white' : 'bg-amber-500 text-white'); ?>">
                                    <?php echo e($violation->kategori); ?>
                        ...
                        <!-- Info -->
                        <div class="p-4">
                            <h4 class="font-semibold text-gray-800"><?php echo e($violation->jenis_pelanggaran); ?></h4>
                            <div class="mt-2 flex items-center justify-between text-sm">
                                <span class="px-2 py-1 rounded-lg bg-indigo-100 text-indigo-700 font-medium">
                                    <?php echo e($violation->poin); ?> Poin
                                </span>
                                <span class="text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($violation->created_at)->format('d/m/Y')); ?>
    ...
    <script>
        ...
        function closeTindakanModal() {
            ...
            document.getElementById('tindakan-form').action = "<?php echo e(route('siswa.tindakan.store', ['id' => $siswa->id])); ?>";
