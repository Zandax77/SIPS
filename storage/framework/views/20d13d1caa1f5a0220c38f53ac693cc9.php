...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8 animate-fade-in flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <?php if(isset($isKesiswaan) && $isKesiswaan): ?>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6 animate-fade-in delay-100">
                <form action="<?php echo e(route('jenis.pelanggaran')); ?>" method="GET" class="flex flex-col sm:flex-row gap-4">
                    <!-- Search Input -->
                    <div class="flex-1">
                    ...
                    <div class="w-full sm:w-48">
                        ...
                        <select name="kategori" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all outline-none bg-white">
                            ...
                            <?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k->id); ?>" <?php echo e($filterKategori == $k->id ? 'selected' : ''); ?>>
                                    <?php echo e($k->nama); ?> (<?php echo e($k->poin); ?> poin)
                                </option>
                ...
                <div class="bg-white rounded-xl p-4 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-800"><?php echo e($stats['total_jenis']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-emerald-600"><?php echo e($stats['ringan']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-amber-600"><?php echo e($stats['sedang']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-rose-600"><?php echo e($stats['berat']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden animate-fade-in delay-300">
                ...
                <?php if(count($jenisPelanggaran) > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $jenisPelanggaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e(($jenisPelanggaran->currentPage() - 1) * $jenisPelanggaran->perPage() + $index + 1); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <p class="text-sm font-medium text-gray-800"><?php echo e($data->nama); ?></p>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                            <?php echo e($data->jumlah_pelanggaran); ?>x
                                        </td>
                                        <?php if(isset($isKesiswaan) && $isKesiswaan): ?>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center gap-2">
                                                    <button onclick="editJenis(<?php echo e($data->id); ?>, '<?php echo e(addslashes($data->nama)); ?>', <?php echo e($data->id_kategori_pelanggaran); ?>, '<?php echo e(addslashes($data->deskripsi)); ?>')"
                                                    ...
                                                    <form action="<?php echo e(route('jenis.pelanggaran.delete', $data->id)); ?>" method="POST" class="inline" onsubmit="return confirmDelete(event)">
                                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="px-6 py-4 border-t border-gray-100">
                        <?php echo e($jenisPelanggaran->appends(['search' => $search, 'kategori' => $filterKategori])->links()); ?>
    ...
    <div id="jenisModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 animate-fade-in">
                ...
                <form id="jenisForm" action="<?php echo e(route('jenis.pelanggaran.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="id_kategori_pelanggaran" id="jenisKategori" required
                            ...
                            <?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k->id); ?>"><?php echo e($k->nama); ?> (<?php echo e($k->poin); ?> poin)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-6 animate-fade-in max-h-[90vh] overflow-y-auto">
                ...
                <div class="mb-8 bg-gray-50 rounded-xl p-4">
                    ...
                    <form action="<?php echo e(route('kategori.pelanggaran.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                                <div class="flex-1">
                                    <p class="font-medium text-gray-800"><?php echo e($k->nama); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e($k->poin); ?> Poin</p>
                                </div>
                                <div class="flex items-center gap-2">
                                    <button onclick="editKategori(<?php echo e($k->id); ?>, '<?php echo e(addslashes($k->nama)); ?>', <?php echo e($k->poin); ?>)"
                                        class="p-2 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </button>
                                    <form action="<?php echo e(route('kategori.pelanggaran.delete', $k->id)); ?>" method="POST" class="inline" onsubmit="return confirmDelete(event)">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit"
                                            class="p-2 text-rose-600 hover:text-rose-700 hover:bg-rose-50 rounded-lg transition-colors">
    ...
    <script>
        ...
        function editJenis(id, nama, kategori, deskripsi) {
            ...
            document.getElementById('jenisForm').action = '<?php echo e(route('jenis.pelanggaran.update', ':id')); ?>'.replace(':id', id);
        ...
        function editKategori(id, nama, poin) {
            document.getElementById('editKategoriForm').action = '<?php echo e(route('kategori.pelanggaran.update', ':id')); ?>'.replace(':id', id);
...
<?php /**PATH /Users/abscom23/Documents/SIPS/resources/views/jenis-pelanggaran.blade.php ENDPATH**/ ?>