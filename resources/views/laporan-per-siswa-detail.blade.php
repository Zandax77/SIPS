...
<head>
    ...
    <title>Laporan Detail Pelanggaran Siswa - {{ $siswa->name }} - SIPS</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-4">
                        <a href="{{ route('laporan.per-siswa') }}" class="flex items-center gap-2 text-gray-600 hover:text-indigo-600 transition-colors">
        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-2xl p-4 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6 animate-fade-in">
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('laporan.per-siswa.detail.pdf', $siswa->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-rose-100 text-rose-700 rounded-lg hover:bg-rose-200 transition-colors font-medium">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            @if($data->sudah_diampuni)
                                                <span class="inline-flex flex-col items-center">
                                                    <span class="text-gray-400 line-through text-sm">{{ $data->poin }}</span>
                                                    <span class="text-xs text-emerald-600">Diampuni</span>
                                                </span>
                                            @elseif($data->poin_dikurangi > 0)
                                                <span class="inline-flex flex-col items-center">
                                                    <span class="text-gray-400 line-through text-sm">{{ $data->poin }}</span>
                                                    <span class="text-xs text-amber-600">-{{ $data->poin_dikurangi }}</span>
                                                </span>
                                            @else
                            ...
                            <tfoot class="bg-gray-50">
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-center text-lg font-bold
                                        @if($totalPoin == 0) text-emerald-600
                                        @elseif($totalPoin <= 10) text-amber-600
