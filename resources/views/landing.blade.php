...
<body class="bg-gray-50 min-h-screen">
    ...
    <button id="install-app-btn" 
            class="hidden fixed bottom-6 right-6 z-50 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-3 rounded-full shadow-lg shadow-indigo-300 hover:shadow-xl transition-all duration-300 flex items-center gap-2 font-medium">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    @if($sekolah && $sekolah->logo_url)
                        <img src="{{ $sekolah->logo_url }}" alt="Logo" class="w-10 h-10 rounded-xl object-contain">
                    @else
                    ...
                    @endif
                    <span class="text-xl font-bold text-gray-800">{{ $sekolah && $sekolah->nama_sekolah ? $sekolah->nama_sekolah : 'SIPS' }}</span>
                </div>
                ...
                <!-- CTA Buttons -->
                <div class="flex items-center gap-3">
                    <a href="{{ route('login') }}" class="px-4 py-2 text-gray-600 hover:text-primary-600 font-medium transition-colors">
                        Masuk
                    </a>
                    <a href="{{ route('petugas.register.show') }}" class="px-5 py-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-medium rounded-lg hover:from-primary-600 hover:to-primary-700 transition-all shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 transform hover:-translate-y-0.5">
                        Daftar
                    </a>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left animate-slide-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('petugas.register.show') }}" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-medium rounded-xl hover:from-primary-600 hover:to-primary-700 transition-all shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 transform hover:-translate-y-0.5">
                            <span>Mulai Sekarang</span>
                            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
                        </a>
                        <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-6 py-3 bg-white text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors shadow-md border border-gray-200">
    ...
    <section class="py-16 bg-gradient-to-r from-primary-600 to-primary-800">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('petugas.register.show') }}" class="px-8 py-3 bg-white text-primary-600 font-medium rounded-xl hover:bg-gray-50 transition-colors shadow-lg">
                    Daftar Sekarang
                </a>
                <a href="{{ route('login') }}" class="px-8 py-3 bg-primary-700 text-white font-medium rounded-xl hover:bg-primary-600 transition-colors border border-primary-500">
                    Login
                </a>
            </div>
        </div>
