            ...
            <div class="flex flex-col h-full">
                ...
                <div class="px-4 py-4 border-t border-gray-100">
                    <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-4">
                        @if($sekolah && $sekolah->nama_sekolah)
                            <p class="text-sm font-semibold text-gray-800 mb-1">{{ $sekolah->nama_sekolah }}</p>
                            @if($sekolah->alamat_sekolah)
                                <p class="text-xs text-gray-500 truncate">{{ $sekolah->alamat_sekolah }}</p>
                            @endif
                        @else
